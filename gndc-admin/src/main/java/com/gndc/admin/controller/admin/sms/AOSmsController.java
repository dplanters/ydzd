package com.gndc.admin.controller.admin.sms;
...
import com.gndc.admin.mappers.SmsConditionMapping;
import com.gndc.admin.mappers.SmsSignMapping;
import com.gndc.admin.mappers.SmsTemplateMapping;
import com.gndc.admin.service.platform.SystemScheduleJobService;
import com.gndc.admin.service.sms.*;
...
//        response.setData(smsConditions);
    ...
    public ResponseMessage<CommonResponse> realTimeSend(@Validated @RequestBody AOSmsRealTimeSendRequest request) throws Exception {
         ...
         *
         *
         * 该方法要是改动，com.gndc.admin.quartz.util.TaskUtils也需要同步改动
         *
         *
         */
        ResponseMessage<CommonResponse> response = new ResponseMessage<>();
