...
public class HttpClientUtil {
    ...
    public static String get(String url, Map<String, String> paramsMap, String encoding) throws HjException {
    ...
    public static String getWithProxy(String url, Map<String, String> paramsMap, String encoding) throws HjException {
